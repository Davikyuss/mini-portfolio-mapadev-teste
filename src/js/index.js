/* 
OJETIVO - quando clicarmos na aba temos que mostrar o
conteudo da aba que foi clicada pelo usuario e esconder o
conteudo da aba anterior.

-passo 1 - dar um jeito de pegar os elementos que representam as abasno HTML

-passo 2 - //       //   de identificar o clique no elemento
...
abas.forEach(aba => {
    aba.addEventListener("click", function () {
        ...
        // passo 6
        const idDoElementoDeInformacoesDaAba = `ìnformacao-${aba.id}`
